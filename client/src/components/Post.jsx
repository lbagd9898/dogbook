...
export default function Post() {
  return (
    <div className="border border-2 p-4 border-[#82C88F] rounded-md w-[40vw] font-doggy flex flex-col gap-2 shadow-md bg-gradient-to-br from-slate-50 to-slate-100 hover:ring-1 hover:ring-zinc-600">
      <div>
